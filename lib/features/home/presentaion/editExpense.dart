...
class EditExpense extends StatefulWidget {
  ...
  const EditExpense({super.key, required this.model});
              ...
              child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomTextField(
                        hint: "Expense Title",
                        initialValue: widget.model.title, //formData["title"],
                      ...
                      CustomTextField(
                        ...
                        hint: "Expense Amount",
                        initialValue: widget.model.amount.toString(),
                          ...
                          child: ElevatedButton(
                              onPressed: () {
                                if (key.currentState!.validate() &&
                                  ...
                                  print(formData);
                                  editExpense(
                                      context, formData, widget.model.id!);
                                } else {
...
void editExpense(BuildContext ctx, Map form, int id) async {
  var x = ExpenseModel(id, form["title"], form["amount"], form["date"]);
  await ctx.read<ExpensesController>().editExpense(x);
  ctx.pop();
}
